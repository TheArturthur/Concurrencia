...
public class EnclavamientoCSP implements CSProcess, Enclavamiento {
     ...
     */
    private static final One2OneChannel chAvisarPresencia     = Channel.one2one();
    private static final One2OneChannel chAvisarPasoPorBaliza = Channel.one2one();
    // leerCambioBarrera blocks depending on a boolean parameter
    private static final One2OneChannel chLeerCambioBarreraT  = Channel.one2one();
    private static final One2OneChannel chLeerCambioBarreraF  = Channel.one2one();
    // leerCambioFreno blocks depending on a boolean parameter
    private static final One2OneChannel chLeerCambioFrenoT    = Channel.one2one();
    private static final One2OneChannel chLeerCambioFrenoF    = Channel.one2one();
    // leerCambioSemaforo blocks depending on a semaphore id and a colour
    private static final One2OneChannel[][] chLeerCambioSemaforo =
